...
export default function QuranTranslation({navigation}) {
    ...
    return (
        <ImageBackground source={require('../assets/background.png')} style={styles.background}
          ...
          <Text style={styles.title}>The Holy Quran Translation</Text>
          <Text style={{color:'white', fontSize:18,textAlign:'center'}}>Select the Surahs Below</Text>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                style={styles.card}
                onPress={() => navigation.navigate('TranslationDetails', { surah: item })}
              >
